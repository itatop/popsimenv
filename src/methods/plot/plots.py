...
def plot_fsc_results_human_IM_general(fsc_infile, outfile, simulated_genome_length, params):

    sns.set(style="whitegrid")

    ## convert fsc estimates to be comparable and add "A-" needed for converting df to long format
...
def plot_fsc_results_human_IM(fsc_infile, outfile, simulated_genome_length,T_Div):
