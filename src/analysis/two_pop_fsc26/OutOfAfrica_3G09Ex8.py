...
# without the event that was missing (old version)
# to be called:
# model = OutOfAfrica_3G09Ex8.build_model(OutOfAfrica_3G09Ex8.build_model_params())
...
def build_model_params():
    ...
    generation_time = 25
    T_AF = 330e3 / generation_time
    T_B = 300e3 / generation_time
